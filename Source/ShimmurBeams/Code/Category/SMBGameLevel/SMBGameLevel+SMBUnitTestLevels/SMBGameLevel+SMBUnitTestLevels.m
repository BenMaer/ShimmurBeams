...
+(nonnull instancetype)smb_powerToggle_beamEntityManagerStuck
{
	...
	SMBGameBoard* const gameBoard = [[SMBGameBoard alloc] init_with_numberOfColumns:
									 (section_1_width
									  +
	...
	NSMutableSet<id<SMBGenericPowerOutputTileEntity_OutputPowerReceiver>>* const outputPowerReceiverCollections_1_outputPowerReceivers_blacklisted = [NSMutableSet<id<SMBGenericPowerOutputTileEntity_OutputPowerReceiver>> set];
	...
	/* Generic Power Output Tile Entities. */

	[gameBoard gameBoardTileEntity_add:[[SMBGenericPowerOutputTileEntity alloc] init_with_outputPowerReceiver:outputPowerReceiverCollections_1_genericPowerOutputTileEntity_OutputPowerReceiverCollection]
